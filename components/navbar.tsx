...
const Navbar = () => {
  ...
  return (
    <nav className="fixed top-3 sm:left-1/2 -translate-x-1/2 z-[999] w-fit backdrop-blur-lg bg-black/50 rounded-xl py-1 px-1 sm:px-2 sm:py-2 shadow-xl">
      {/* Desktop Navigation */}
...
<main
  ...
  transform ${isOpen ? "translate-x-0 opacity-100" : "translate-x-full opacity-0 pointer-events-none"} bg-white dark:bg-black/90`}
  aria-hidden={!isOpen}
>
